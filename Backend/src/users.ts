...
export async function request_activation(req:Request,res:Response){
    ...
    try{
        await prisma.$transaction(async(prisma)=>{
            let user=(await prisma.authTokens.findUniqueOrThrow({
                where:{
                    value:token,
                    purpose:"SIGNUP",
                    expiration:{
...
export async function log_in(req:Request,res:Response){
    ...
    let password=req.body.password;
    try{
        let hashed=(await prisma.users.findUniqueOrThrow({
            where:{
                username:username,
                active:true
            },
...
export async function refresh(req:Request,res:Response){
    ...
    try{
        ...
        let username=(await prisma.authTokens.findUniqueOrThrow({
            where:{
                purpose:"REFRESH",
